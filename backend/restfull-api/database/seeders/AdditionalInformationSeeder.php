...
class AdditionalInformationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $additionalinformations = [
            ...
            de concurrentiestrijd met die uit Amsterdam en verdwenen de brouwerijen in de stad.", 'img' => "", 'cordinate_x' => 0.03, 'cordinate_y' => -0.56],
            ...
            gecombineerd aan de latere Catharijnekade. Omstreeks 1859.", 'img' => "", 'cordinate_x' => 0.03, 'cordinate_y' => -0.56],
            ['title' => "", 'panorama_id' => 10, 'description' => "Gezicht op de Stadsbuitengracht en de Catharijnebrug te Utrecht, uit
            ...
            Omstreeks 1859.", 'img' => "", 'cordinate_x' => 0.03, 'cordinate_y' => -0.56],
            ...
            aanvang van het jaar 1857", 'img' => "", 'cordinate_x' => 0.03, 'cordinate_y' => -0.56],
            ...
            is het noordwestelijke bastion van het vroegere kasteel Vredenburg. Foto uit omstreeks 1859", 'img' => "", 'cordinate_x' => 0.03, 'cordinate_y' => -0.56],
            ...
            Met legenda en een aantal doorhalingen en notities.", 'img' => "", 'cordinate_x' => 0.03, 'cordinate_y' => -0.56],
            ...
            begin van het in Engelse landschapsstijl aangelegde singelplantsoen.", 'img' => "", 'cordinate_x' => 0.03, 'cordinate_y' => -0.56],
            ...
            zuiden. Omstreeks 1850", 'img' => "", 'cordinate_x' => 0.03, 'cordinate_y' => -0.56],
            ...
            cholera-uitbraken in de jaren 1870.", 'img' => "", 'cordinate_x' => 0.03, 'cordinate_y' => -0.56],
            ...
            wandeling. Met lijst van belangrijke gebouwen en overige objecten. Datering rond 1858", 'img' => "", 'cordinate_x' => 0.03, 'cordinate_y' => -0.56],
            ...
            Instituut op het voormalige bastion Zonnenburg. Foto omstreeks 1859.", 'img' => "", 'cordinate_x' => 0.03, 'cordinate_y' => -0.56],
            ['title' => "", 'panorama_id' => 23, 'description' => "Gezicht over de stadsbuitengracht te Utrecht op de Sterrenwacht
            (Astronomisch Observatorium) op het voormalige bastion Zonnenburg. Foto omstreeks 1859.", 'img' => "", 'cordinate_x' => 0.03, 'cordinate_y' => -0.56],
            ['title' => "", 'panorama_id' => 24, 'description' => "Plattegrond van een niet gevoerd ontwerp van Zocher voor eenplantsoen op het bastion Lepelenburg te Utrecht.", 'img' => "", 'cordinate_x' => 0.03, 'cordinate_y' => -0.56],
            ...
            noordoosten.", 'img' => "", 'cordinate_x' => 0.03, 'cordinate_y' => -0.56],
            ...
            opgebouwd uit schijnbaar willekeurig geplaatste ruwe boomstammetjes. ", 'img' => "", 'cordinate_x' => 0.03, 'cordinate_y' => -0.56],
