...
class AdditionalInformationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $additionalinformations = [
            ...
            binnenstad vervoerden, werden in de loop van de 19e eeuw vervangen door vaste bruggen.", 'img' => "/img/page-4-1.jpg", 'cordinate_x' => 0.84, 'cordinate_y' => -0.23],   
            ...
            de concurrentiestrijd met die uit Amsterdam en verdwenen de brouwerijen in de stad.", 'img' => "/img/page-8-1.jpg", 'cordinate_x' => 0.55, 'cordinate_y' => -0.11],
            ...
            gecombineerd aan de latere Catharijnekade. Omstreeks 1859.", 'img' => "/img/page-10-1.jpg", 'cordinate_x' => 0.46, 'cordinate_y' => -0.17],
            ['title' => "", 'panorama_id' => 10, 'description' => "Gezicht op de Stadsbuitengracht en de Catharijnebrug te Utrecht, uit
            ...
            Omstreeks 1859.", 'img' => "/img/page-10-2.jpg", 'cordinate_x' => 0.07, 'cordinate_y' => -0.17],
            ...
            aanvang van het jaar 1857", 'img' => "/img/page-10-3.jpg", 'cordinate_x' => 0.8, 'cordinate_y' => -0.25],
            ...
            is het noordwestelijke bastion van het vroegere kasteel Vredenburg. Foto uit omstreeks 1859", 'img' => "/img/page-10-4.jpg", 'cordinate_x' => 0.33, 'cordinate_y' => -0.22],
            ...
            Met legenda en een aantal doorhalingen en notities.", 'img' => "/img/page-11-1.jpg", 'cordinate_x' => 0.06, 'cordinate_y' => -0.02],
            ...
            zuiden. Omstreeks 1850", 'img' => "/img/page-12-1.jpg", 'cordinate_x' => 0.95, 'cordinate_y' => -0.35],
            ...
            Domtoren. Omstreeks 1850", 'img' => "/img/page-12-2.jpg", 'cordinate_x' => 0.67, 'cordinate_y' => -0.40],
            ...
            cholera-uitbraken in de jaren 1870.", 'img' => "/img/page-13-1.jpg", 'cordinate_x' => 0.1, 'cordinate_y' => -0.20],
            ...
            wandeling. Met lijst van belangrijke gebouwen en overige objecten. Datering rond 1858", 'img' => "/img/page-14-1.jpg", 'cordinate_x' => 0.48, 'cordinate_y' => 0.07],
            ...
            Instituut op het voormalige bastion Zonnenburg. Foto omstreeks 1859.", 'img' => "/img/page-23-1.jpg", 'cordinate_x' => 0.4, 'cordinate_y' => 0.2],
            ['title' => "", 'panorama_id' => 23, 'description' => "Gezicht over de stadsbuitengracht te Utrecht op de Sterrenwacht
            (Astronomisch Observatorium) op het voormalige bastion Zonnenburg. Foto omstreeks 1859.", 'img' => "/img/page-23-2.jpg", 'cordinate_x' => 0.8, 'cordinate_y' => 0.05],
            ['title' => "", 'panorama_id' => 24, 'description' => "Plattegrond van een niet gevoerd ontwerp van Zocher voor eenplantsoen op het bastion Lepelenburg te Utrecht.", 'img' => "/img/page-24-1.jpg", 'cordinate_x' => 0.92, 'cordinate_y' => 0.1],
            ...
            noordoosten.", 'img' => "/img/page-26-1.jpg", 'cordinate_x' => 0.78, 'cordinate_y' => -0.4],
            ...
            opgebouwd uit schijnbaar willekeurig geplaatste ruwe boomstammetjes. ", 'img' => "/img/page-31-1.jpg", 'cordinate_x' => 0.38, 'cordinate_y' => -0.26],
            ['title' => "", 'panorama_id' => 32, 'description' => "Gezicht op het Lucasbolwerk met het Suikerhuis te Utrecht, vóór de
            afbraak, uit het noorden.", 'img' => "/img/page-32-1.jpg", 'cordinate_x' => 0.29, 'cordinate_y' => 0.05],
